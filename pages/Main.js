...
const styles = {
  wrapper: 'flex h-[100vh] w-[100vw] bg-[#fff] text-black',
  container:
  ...
  mintButton:
    'rounded-xl border border-gray-100 bg-black px-8 py-4 font-semibold text-gray-100 transition-all hover:bg-gray-100 hover:text-[#1d1d1d]',
}
              ...
              candyState && (
                <div>
                   ...
                   <div className={styles.buttonContainer}>
                    <buttom className={styles.mintButton} onClick={mint} disabled={!wallet || txLoading || soldOut}>
